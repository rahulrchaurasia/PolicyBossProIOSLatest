        ...
        if indexPath.row == 0 {
            ...
            for (index,value) in nameArray.enumerated() {
                if index % 2 == 0 {
                    ...
                    //005
                    cell.hidecellLbl.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: oddArray,  bullet: "✓ ")
...
//                      cell.hidecellLbl.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: oddArray, font: UIFont.systemFont(ofSize: 15), bullet: "✓ ")
                    ...
                    // 005
                    cell.hidecellLbl2.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: evenArray,  bullet: "✓ ")
...
//                       cell.hidecellLbl2.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: evenArray, font: UIFont.systemFont(ofSize: 15), bullet: "✓ ")
            ...
            for (index1,value1) in result.enumerated() {
                if index1 % 2 == 0 {
                    ...
                    //005
                    cell.hidecellBtnLbl1.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: oddArrayC, bullet: " ")
...
//                      cell.hidecellBtnLbl1.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: oddArrayC, font: UIFont.systemFont(ofSize: 16), bullet: " ")
                    ...
                    //005
                    cell.hidecellBtnLbl2.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: evenArrayC, bullet: " ")
...
//
    ...
    @objc func tapFunction(sender:UITapGestureRecognizer)
    {
        ...
        healthTests.modalPresentationStyle = .fullScreen
