...
class lyfinsInputPageVC: UIViewController,SelectedDateDelegate,getPickerDataDelegate,UITextFieldDelegate {
    
    @IBOutlet var topfrstView: UIView!
    @IBOutlet var topfrstViewHeight: NSLayoutConstraint!//80
    @IBOutlet var quoteSecondView: UIView!
    @IBOutlet var quoteSecondViewHeight: NSLayoutConstraint!//120
    @IBOutlet var bankimageView: UIView!
    @IBOutlet var planeView: UIView!
    @IBOutlet var sharecartView: UIView!
    @IBOutlet var coverView: UIView!
    @IBOutlet var policyTermView: UIView!
    @IBOutlet var uptodateView: UIView!
    ...
    override func viewDidLoad() {
        ...
        compPincodeTf.text! = pincde
        compsumAssuredTf.text! = sumassurd
        comppolicytermLbl.text! = plcytrm + " YEARS"
        premtermLbl.text! = pretrm + " YEARS"
        
        compsumAssuredTf.text! = "10000000"
...
//        icicacceDeathTfValue = 10000000
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool
    {
        ...
        else if(textField == compPincodeTf || textField == hdfcPincodeTf || textField == icicPincodeTf)
        {
...
//        }
    ...
    func smarttermlifeAPI()
    {
        ...
        params["termRequestEntity"] = ["ADBPercentage": "0",
                                       ...
                                       "MaritalStatus": "",
                                       "MonthlyIncome": "0",
                                       "PPT": premtermLbl.text!.components(separatedBy: " ").dropLast().joined(separator: " "),
                                       "PaymentModeValue": "1",
                                       "PaymentOptn": nil,
                                       "PlanTaken": "Life",
                                       "PolicyCommencementDate": dobTf.text!,
                                       "PolicyTerm": comppolicytermLbl.text!.components(separatedBy: " ").dropLast().joined(separator: " "),
                                       "PremiumPaymentOption": "",
                                       "ServiceTaxNotApplicable": "",
                                       "SessionID": "",
                                       "State": "Maharashtra",
                                       "SumAssured": compsumAssuredTf.text!,
...
//                let CustomerReferenceIDString = String(CustomerReferenceID)
                ...
                UserDefaults.standard.set(String(describing: self.compPincodeTf.text!), forKey: "compPincode")
                ...
                UserDefaults.standard.set(String(describing: self.dobTf.text!), forKey: "dobTf")
                UserDefaults.standard.set(String(describing: self.gender), forKey: "gender")
                UserDefaults.standard.set(String(describing: self.mobNoTf.text!), forKey: "mobNoTf")
                UserDefaults.standard.set(String(describing: self.premtermLbl.text!.components(separatedBy: " ").dropLast().joined(separator: " ")), forKey: "premtermLbl")
                UserDefaults.standard.set(String(describing: self.comppolicytermLbl.text!.components(separatedBy: " ").dropLast().joined(separator: " ")), forKey: "comppolicytermLbl")
                UserDefaults.standard.set(String(describing: self.compsumAssuredTf.text!), forKey: "compsumAssuredTf")
                
                UserDefaults.standard.set(String(describing: CustomerReferenceID), forKey: "CustomerReferenceID")
                UserDefaults.standard.set(String(describing: ProductPlanNameArray), forKey: "ProductPlanName")
                UserDefaults.standard.set(String(describing: PolicyTermYearArray), forKey: "PolicyTermYear")
                UserDefaults.standard.set(String(describing: SumAssuredArray), forKey: "SumAssured")
                UserDefaults.standard.set(String(describing: NetPremiumArray), forKey: "NetPremium")
