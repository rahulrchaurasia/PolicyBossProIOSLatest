...
//            cell.headerLbl.text = sectionTitles[indexPath.section]
            ...
            cell.cellLbl.attributedText = NSAttributedStringHelper.createBulletedList(fromStringArray: spliteString[indexPath.section], font: UIFont.systemFont(ofSize: 16))
